...
const topics = ["Web API", "Microservices"];
...
const topicsData: any = {
  ...
  "Microservices": {
    ...
    desc: "Architecture, Communication & Gateway"
  },
};

export default function MicroservicesTopics() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-gray-50 to-blue-50 px-6 py-16">
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-gray-500 mt-3">
          Start with Web API or jump into Microservices
        </p>
      </div>
        ...
        {topics.map((key) => {
          ...
          return (
            <div
              ...
              onClick={() => {
                if (key === "Web API") {
                  navigate("/webapi-topic/webapi");
                } else {
                  navigate("/webapi-topic/microservices");
                }
              }}
